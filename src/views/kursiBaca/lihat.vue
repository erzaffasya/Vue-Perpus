      ...
      if (this.searchQuery) {
        ...
        return this.displayedPosts.filter((data) => {
          return (
            ...
            (data.kursi && data.kursi.toLowerCase().includes(search)) ||
            (data.ruangan_baca && data.ruangan_baca.toLowerCase().includes(search))
          );
        });
      } else {
  ...
  methods: {
    ...
    confirm(id) {
      Swal.fire({
        ...
        if (result.value) {
          apiKursiBaca.hapusKursiBaca(id).then(() => {
            this.getKursiBaca();
          });
          Swal.fire("Berhasil!", "Data Kursi Baca Berhasil Dihapus.", "success");
        }
      });
    },
  },
                              ...
                              >
                                ...
                                <tbody class="list form-check-all">
                                  ...
                                  >
                                    ...
                                    <td class="amount">{{ data.ruangan_baca }}</td>
                                    <td>
                                      <ul class="list-inline hstack gap-2 mb-0">
                                        <!-- <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                          data-bs-placement="top" title="View">
                                          <router-link to="/ecommerce/order-kursis"
