        ...
        <div class="card card-animate">
          <div class="card-body">
            <div class="d-flex">
              ...
              <div class="flex-shrink-0 avatar-sm">
                <div
                  class="avatar-title bg-soft-info text-info fs-22 rounded"
                >
                ...
                <div class="p-3">
                  ...
                  <div class="mt-3 pt-2">
                    <div class="d-flex mb-2">
                      <div class="flex-grow-1">
                        <p class="fs-14 mb-0">
                          Transaction Fees<span class="text-muted ms-1 fs-12"
                            >(0.05%)</span
                          >
                        </p>
                      </div>
                    ...
                    <div class="d-flex mb-2">
                      <div class="flex-grow-1">
                        <p class="fs-14 mb-0">
                          Minimum Received<span class="text-muted ms-1 fs-12"
                            >(2%)</span
                          >
                        </p>
                      </div>
