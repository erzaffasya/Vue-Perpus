    ...
    return {
      ...
      projectListWidgets2: [
        ...
        },
        {
          ...
          subItem: [
            { id: 1, imgNumber: "D", bgColor: "warning" },
            { id: 2, imgTeam: require("@/assets/images/users/avatar-7.jpg") },
            { id: 3, imgTeam: require("@/assets/images/users/avatar-8.jpg") },
            { id: 4, imgNumber: "+" },
          ],
          progressBar: "95%",
        },
              ...
              <div class="d-flex">
                ...
                <div class="flex-shrink-0">
                  <div class="d-flex gap-1 align-items-center">
                    ...
                    <div class="dropdown">
                      <button
                        class="btn btn-link text-muted p-1 mt-n2 py-0 text-decoration-none fs-16"
              ...
              <div class="row gy-3">
                <div class="col-6">
                  <div>
                    ...
                    <div :class="`badge badge-soft-${item.statusClass} fs-13`">
                      {{ item.status }}
                    </div>
                  </div>
                </div>
