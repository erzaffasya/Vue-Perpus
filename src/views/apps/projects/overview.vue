                                    ...
                                    <div class="col-md">
                                        <div>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <div class="vr"></div>
                                                <div>Create Date : <span class="fw-semibold fs-15">15 Sep, 2021</span></div>
                                                <div class="vr"></div>
                                                <div>Due Date : <span class="fw-semibold fs-15">29 Dec, 2021</span></div>
                                                <div class="vr"></div>
                                    ...
                                    <div data-simplebar style="height: 300px;" class="px-3 mx-n3 mb-2">
                                        <div class="d-flex mb-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15">Joseph Parker <small class="text-muted ms-2">20 Dec 2021 - 05:47AM</small></h5>
                                                ...
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-15">Alexis Clarke <small class="text-muted ms-2">22 Dec 2021 - 02:32PM</small></h5>
                                        ...
                                        <div class="d-flex mb-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15">Donald Palmer <small class="text-muted ms-2">24 Dec 2021 - 05:20PM</small></h5>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15">Alexis Clarke <small class="text-muted ms-2">26 min ago</small></h5>
                                                ...
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-15">Donald Palmer <small class="text-muted ms-2">8 sec ago</small></h5>
                                        ...
                                        <div class="vstack gap-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-15 mb-0"><a href="#" class="text-body d-block">Nancy Martino</a></h5>
                                                </div>
                                                <div class="flex-shrink-0">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-15 mb-0"><a href="#" class="text-body d-block">Henry Baird</a></h5>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <button type="button" class="btn btn-light btn-sm">Message</button>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-15 mb-0"><a href="#" class="text-body d-block">Frank Hook</a></h5>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <button type="button" class="btn btn-light btn-sm">Message</button>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-15 mb-0"><a href="#" class="text-body d-block">Jennifer Carter</a></h5>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <button type="button" class="btn btn-light btn-sm">Message</button>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-15 mb-0"><a href="#" class="text-body d-block">Alexis Clarke</a></h5>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <button type="button" class="btn btn-light btn-sm">Message</button>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-15 mb-0"><a href="#" class="text-body d-block">Joseph Parker</a></h5>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <button type="button" class="btn btn-light btn-sm">Message</button>
