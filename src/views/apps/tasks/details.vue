                                ...
                                <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-14"><router-link to="/pages/profile">Joseph Parker</router-link> <small class="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                            ...
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-14"><router-link to="/pages/profile">Tonya Noble</router-link> <small class="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                                    ...
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-14"><router-link to="/pages/profile">Thomas Taylor</router-link> <small class="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-14"><router-link to="/pages/profile">Tonya Noble</router-link> <small class="text-muted">26 min ago</small></h5>
                                            ...
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-14"><router-link to="/pages/profile">Nancy Martino</router-link> <small class="text-muted">8 sec ago</small></h5>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 ms-2">
                                                            <router-link to="/pages/profile" class="fw-semibold">Thomas Taylor</router-link>
                                                        </div>
                                                    </div>
                                                </th>
                                                <td>02 Jan, 2022</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 ms-2">
                                                            <router-link to="/pages/profile" class="fw-semibold">Tonya Noble</router-link>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>28 Dec, 2021</td>
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-4 d-flex align-items-center">
                            <div class="me-2">
                                <h5 class="mb-0 fs-14">Members :</h5>
                            </div>
                            ...
                            <div class="vstack gap-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-0"><a href="javascript:void(0);" class="text-body d-block">Nancy Martino</a></h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-0"><a href="javascript:void(0);" class="text-body d-block">Henry Baird</a></h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-light btn-sm">Add</button>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-0"><a href="javascript:void(0);" class="text-body d-block">Frank Hook</a></h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-light btn-sm">Add</button>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-0"><a href="javascript:void(0);" class="text-body d-block">Jennifer Carter</a></h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-light btn-sm">Add</button>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-0"><a href="javascript:void(0);" class="text-body d-block">Alexis Clarke</a></h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-light btn-sm">Add</button>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-0"><a href="javascript:void(0);" class="text-body d-block">Joseph Parker</a></h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-light btn-sm">Add</button>
                                    </div>
