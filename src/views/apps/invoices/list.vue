...
export default {
  ...
  components: {
    ...
    Multiselect,
    lottie: Lottie,
    FileTextIcon ,CheckSquareIcon ,ClockIcon, XOctagonIcon
  },
  computed: {
    displayedPosts() {
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <h5 class="text-success fs-14 mb-0">
                                <i :class="`${item.icon} fs-14 align-middle`"></i> {{item.percentage}}
                            </h5>
                        </div>
                    </div>
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-bold ff-secondary mb-4">{{item.prefix}}{{item.counter}}{{item.suffix}}</h4>
                            <span class="badge bg-warning me-1">{{item.badge}}</span> <span class="text-muted"> {{item.caption}}</span>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-light rounded fs-3">
                                <template v-if="item.feaIcon == 'file-text'">
                                    <FileTextIcon class="text-info icon-dual-info"/>
                                </template>
                                ...
                                <template v-if="item.feaIcon == 'clock'">
                                    <ClockIcon class="text-info icon-dual-info"/>
                                </template>
              ...
              <div class="card" id="invoiceList">
                  <div class="card-header border-0">
                      <div class="d-flex align-items-center">
                          ...
                          <div class="flex-shrink-0">
                              <router-linkj to="/invoices/create" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> Create Invoice</router-linkj>
                          </div>
                      </div>
                  </div>
                      ...
                      <div>
                              ...
                              <table class="table align-middle table-nowrap" id="invoiceTable">
                                  ...
                                  <tbody class="list form-check-all">
                                      <tr v-for="(item, index) of resultQuery" :key="index">
                                          ...
                                          <td class="id"><router-link to="/invoices/detail" class="fw-semibold link-primary">{{item.invoiceId}}</router-link></td>
                                          ...
                                          <td class="status"><span :class="`badge badge-soft-${item.statusClass} text-uppercase`">{{item.status}}</span></td>
                                          <td>
                                              <div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu dropdown-menu-end">
                                                      <li><router-link class="dropdown-item" to="/invoices/detail"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</router-link></li>
                                                      <li><a class="dropdown-router-linkj" to="/invoices/create"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <div class="pagination-wrap hstack gap-2">
                                ...
                                <ul class="pagination listjs-pagination mb-0" ><li  :class="{
                                  ...
                                  <div class="modal-body p-5 text-center">
                                      ...
                                      <div class="mt-4 text-center">
                                          ...
                                          <div class="hstack gap-2 justify-content-center remove">
                                              <button class="btn btn-link link-success fw-semibold text-decoration-none" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Close</button>
