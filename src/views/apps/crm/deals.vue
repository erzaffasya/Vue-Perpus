...
<template>
 ...
 <Multiselect class="form-control"
                        ...
                        <div class="dropdown">
                            <button class="btn btn-soft-info btn-icon fs-15" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <a class="card-header bg-soft-primary" data-bs-toggle="collapse" href="#leadDiscovered" role="button" aria-expanded="false" aria-controls="leadDiscovered">
        ...
        <div class="col">
            <div class="card">
                <a class="card-header bg-soft-info" data-bs-toggle="collapse" href="#contactInitiated" role="button" aria-expanded="false" aria-controls="contactInitiated">
        ...
        <div class="col">
            <div class="card">
                <a class="card-header bg-soft-primary" data-bs-toggle="collapse" href="#needsIdentified" role="button" aria-expanded="false" aria-controls="needsIdentified">
        ...
        <div class="col">
            <div class="card">
                <a class="card-header bg-soft-primary" data-bs-toggle="collapse" href="#offerAccepted" role="button" aria-expanded="false" aria-controls="offerAccepted">
