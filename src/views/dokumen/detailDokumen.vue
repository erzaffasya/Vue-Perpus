...
export default {
    methods: {
        ...
        getDokumen() {
            apiDokumen.showDokumen(this.$route.params.id).then((response) => {
                                        ...
                                        <div data-simplebar style="height: 300px;" class="px-3 mx-n3 mb-2">
                                            <div class="d-flex mb-4">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-15">Joseph Parker <small class="text-muted ms-2">20
                                                    ...
                                                    <div class="d-flex mt-4">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="fs-15">Alexis Clarke <small
                                            ...
                                            <div class="d-flex mb-4">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-15">Donald Palmer <small class="text-muted ms-2">24
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-15">Alexis Clarke <small class="text-muted ms-2">26
                                                            min ago</small></h5>
                                                    ...
                                                    <div class="d-flex mt-4">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="fs-15">Donald Palmer <small
