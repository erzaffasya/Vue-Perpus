...
const stackedColumnsChart = {
    ...
    chartOptions: {
        ...
        colors: ["#695FEE", "#48D1B7", "#F8C060", "#F57F41"],
    },
};
...
const columnNegativeChart = {
    series: [{
        ...
        data: [
            1.45,
            5.42,
            5.9, -0.42, -12.6, -18.1, -18.2, -14.16, -11.1, -6.09,
            0.34,
            3.88,
            13.07,
            5.8,
