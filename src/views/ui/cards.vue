            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="javascript:void(0);" class="card-link link-info">
                            Bookmark
                    ...
                    <div class="col-xxl-4 col-lg-6">
                        <div class="card card-body">
                            <div class="avatar-sm mb-3">
                                <div
                                    class="avatar-title bg-soft-info text-info fs-17 rounded"
                                >
                ...
                <div class="row">
                    <div class="col-xxl-4 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0);" class="link-info float-end">
                                    Read More
                                    <i
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <a href="javascript:void(0)" class="btn btn-link btn-sm link-info">
                    ...
                    <div class="card-footer text-center">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item">
                                <a
                                    href="javascript:void(0);"
                                    class="lh-1 align-middle link-info"
                                >
